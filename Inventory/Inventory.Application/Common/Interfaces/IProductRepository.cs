...
public interface IProductRepository
{
    ...
    Task<(int successCount, int updateCount, List<string> errors)> UploadProductsAsync(Microsoft.AspNetCore.Http.IFormFile file, Guid companyId, string? branchId = null);
