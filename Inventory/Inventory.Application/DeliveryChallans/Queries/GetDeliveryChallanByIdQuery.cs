...
{
    public class GetDeliveryChallanByIdQuery : IRequest<DeliveryChallanDto?>
    {
        public Guid Id { get; set; }
        public GetDeliveryChallanByIdQuery(Guid id)
        {
            Id = id;
        }
    }

    public class GetDeliveryChallanByIdHandler : IRequestHandler<GetDeliveryChallanByIdQuery, DeliveryChallanDto?>
    {
        private readonly IInventoryDbContext _context;

        public GetDeliveryChallanByIdHandler(IInventoryDbContext context)
        {
            _context = context;
        }

        public async Task<DeliveryChallanDto?> Handle(GetDeliveryChallanByIdQuery request, CancellationToken cancellationToken)
        {
