...
public class ConfigurationController : ControllerBase
{
    ...
    public ConfigurationController(IInventoryDbContext dbContext)
    {
    ...
    public IActionResult DownloadTemplate()
    {
        using (var workbook = new XLWorkbook())
        {
            ...
            // Sample Row
            worksheet.Cell(2, 1).Value = "ProductType";
            worksheet.Cell(2, 2).Value = "Sample Product Type";
