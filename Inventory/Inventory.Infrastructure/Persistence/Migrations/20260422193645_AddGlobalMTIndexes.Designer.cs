...
namespace Inventory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260422193645_AddGlobalMTIndexes")]
    partial class AddGlobalMTIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppNotification", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_AppNotification_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_Category_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.ExpenseCategory", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_ExpenseCategory_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.ExpenseEntry", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_ExpenseEntry_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.GRNDetail", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_GRNDetail_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.GRNHeader", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_GRNHeader_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.GatePass", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_GatePass_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.InventoryTransaction", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_InventoryTransaction_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_Product_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.PurchaseReturn", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PurchaseReturn_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.PurchaseReturnItem", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PurchaseReturnItem_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Rack", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_Rack_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.SO.SaleOrder", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_SaleOrder_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.SO.SaleOrderItem", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_SaleOrderItem_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.SaleReturnHeader", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_SaleReturnHeader_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.SaleReturnItem", b =>
                {
                    ...
                    b.Property<Guid>("SaleReturnHeaderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_SaleReturnItem_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Subcategory", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_Subcategory_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Warehouse", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_Warehouse_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.PriceLists.PriceList", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PriceList_CompanyId");
            ...
            modelBuilder.Entity("Inventory.Domain.PriceLists.PriceListItem", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PriceListItem_CompanyId");
            ...
            modelBuilder.Entity("PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PurchaseOrder_CompanyId");
            ...
            modelBuilder.Entity("PurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_PurchaseOrderItem_CompanyId");
            ...
            modelBuilder.Entity("UnitMaster", b =>
                {
                    ...
                    b.HasIndex("CompanyId")
                        .HasDatabaseName("IX_MT_UnitMaster_CompanyId");
